...
func (x *DouyinPublishActionRequest) Reset() {
	*x = DouyinPublishActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_publish_action_proto_msgTypes[0]
...
func (*DouyinPublishActionRequest) Descriptor() ([]byte, []int) {
	return file_proto_publish_action_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinPublishActionResponse) Reset() {
	*x = DouyinPublishActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_publish_action_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishActionResponse) Descriptor() ([]byte, []int) {
	return file_proto_publish_action_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_publish_action_proto protoreflect.FileDescriptor

var file_proto_publish_action_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x2f,
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x64, 0x6f,
	0x75, 0x79, 0x69, 0x6e, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x5f, 0x0a, 0x1d, 0x64, 0x6f, 0x75,
	...
	0x09, 0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x32, 0x7a, 0x0a, 0x0e,
	0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x68,
	...
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1f, 0x5a, 0x1d, 0x73, 0x69, 0x6d, 0x70,
	0x6c, 0x65, 0x2d, 0x64, 0x65, 0x6d, 0x6f, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2f, 0x70,
	0x62, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68,
}

var (
	file_proto_publish_action_proto_rawDescOnce sync.Once
	file_proto_publish_action_proto_rawDescData = file_proto_publish_action_proto_rawDesc
)

func file_proto_publish_action_proto_rawDescGZIP() []byte {
	file_proto_publish_action_proto_rawDescOnce.Do(func() {
		file_proto_publish_action_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_publish_action_proto_rawDescData)
	})
	return file_proto_publish_action_proto_rawDescData
}

var file_proto_publish_action_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_publish_action_proto_goTypes = []interface{}{
...
var file_proto_publish_action_proto_depIdxs = []int32{
...
func init() { file_proto_publish_action_proto_init() }
func file_proto_publish_action_proto_init() {
	if File_proto_publish_action_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_publish_action_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_publish_action_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_publish_action_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_publish_action_proto_goTypes,
		DependencyIndexes: file_proto_publish_action_proto_depIdxs,
		MessageInfos:      file_proto_publish_action_proto_msgTypes,
	}.Build()
	File_proto_publish_action_proto = out.File
	file_proto_publish_action_proto_rawDesc = nil
	file_proto_publish_action_proto_goTypes = nil
	file_proto_publish_action_proto_depIdxs = nil
}
