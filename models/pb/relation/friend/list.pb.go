...
func (*FriendUser_User) Descriptor() ([]byte, []int) {
	return file_list_proto_rawDescGZIP(), []int{3, 0}
}

func (x *FriendUser_User) GetId() int64 {
	if x != nil && x.Id != nil {
		return *x.Id
	}
	return 0
...
func (x *FriendUser_User) GetName() string {
	if x != nil && x.Name != nil {
		return *x.Name
	}
	return ""
...
func (x *FriendUser_User) GetFollowCount() int64 {
	if x != nil && x.FollowCount != nil {
		return *x.FollowCount
	}
	return 0
...
func (x *FriendUser_User) GetFollowerCount() int64 {
	if x != nil && x.FollowerCount != nil {
		return *x.FollowerCount
	}
	return 0
...
func (x *FriendUser_User) GetIsFollow() bool {
	if x != nil && x.IsFollow != nil {
		return *x.IsFollow
	}
	return false
...
func (x *FriendUser_User) GetAvatar() string {
	if x != nil && x.Avatar != nil {
		return *x.Avatar
	}
	return ""
...
func (x *FriendUser_User) GetBackgroundImage() string {
	if x != nil && x.BackgroundImage != nil {
		return *x.BackgroundImage
	}
	return ""
...
func (x *FriendUser_User) GetSignature() string {
	if x != nil && x.Signature != nil {
		return *x.Signature
	}
	return ""
...
func (x *FriendUser_User) GetTotalFavorited() int64 {
	if x != nil && x.TotalFavorited != nil {
		return *x.TotalFavorited
	}
	return 0
...
func (x *FriendUser_User) GetWorkCount() int64 {
	if x != nil && x.WorkCount != nil {
		return *x.WorkCount
	}
	return 0
...
func (x *FriendUser_User) GetFavoriteCount() int64 {
	if x != nil && x.FavoriteCount != nil {
		return *x.FavoriteCount
	}
	return 0
...
var file_list_proto_rawDesc = []byte{
	...
	0x55, 0x73, 0x65, 0x72, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xe1,
	...
	0x6e, 0x74, 0x22, 0xa4, 0x03, 0x0a, 0x0a, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x55, 0x73, 0x65,
	...
	0x73, 0x67, 0x54, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x02, 0x28, 0x03, 0x52, 0x07, 0x6d, 0x73,
	0x67, 0x54, 0x79, 0x70, 0x65, 0x1a, 0xe1, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e,
	...
	0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f,
}
...
var file_list_proto_goTypes = []interface{}{
	...
	(*FriendUser)(nil),                       // 3: douyin.extra.second.FriendUser
	(*FriendUser_User)(nil),                  // 4: douyin.extra.second.FriendUser.User
}
var file_list_proto_depIdxs = []int32{
	3, // 0: douyin.extra.second.douyin_relation_friend_list_response.user_list:type_name -> douyin.extra.second.FriendUser
